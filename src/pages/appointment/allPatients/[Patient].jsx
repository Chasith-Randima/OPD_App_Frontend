...
import {
  allAppointments,
  allAppointmentsRelated,
  searchPatientAppointments,
} from "actions/appointment";
import SearchBar from "components/SearchBar";
import { BsFillFilterSquareFill } from "react-icons/bs";
import SearchPatientAppointments from "components/search/SearchPatientAppointments";
...
const Patient = ({ data, query }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    await allAppointmentsRelated(params)
      .then((data) => {
        if (data.status && data.status == "success") {
          if (data.results == 0) {
            setAlert({
              ...alert,
              message: "No document found ... initilizing for main data..",
            });
            initialSet();
            setShow(false);
          } else {
    ...
    <>
      <Layout>
        ...
        <div className="mt-2 mb-2 p-2 mr-10 border-2 border-gray-200 rounded-xl grid grid-cols-4">
          {/* <SearchBar /> */}
          <SearchPatientAppointments patientId={query.Patient} />
          <div
        ...
        {show ? (
          ...
          <div className="mt-10 mr-10 border-2 border-gray-200 rounded-xl">
            <div className="grid grid-cols-6 md:grid-cols-8 bg-gray-600 p-4 rounded-xl text-white text-xl font-sb ">
              <h2>Id</h2>
...
Patient.getInitialProps = async ({ query }) => {
  ...
  return allAppointmentsRelated(data)
    .then((data) => {
      return { data, query };
    })
    .catch((err) => {
